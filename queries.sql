...
/*List all the customers for whom the invoices were raised for a particular time period (start date time and end date time will be parameter to the query)*/
